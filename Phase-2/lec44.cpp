...
// circular doubly node...did the HW ^^
...
int main()
{
    ...
    //(done)HW->deletion at a value of data
    // deleteValue(head,tail,14);
    // print(head);
    ...
    // Dnode* tail = head;
    // print(head);
    // cout<< D_length(head)<<endl;

    // if want to start from zero:
    //  Dnode*head=new Dnode(10);
    //  Dnode*tail=head;

    // insertion at Head
    //  D_insertAtHead(head,20);
    //  D_insertAtHead(head,30);
    //  D_insertAtHead(head,40);
    //  print(head);

    // insertion at tail
    //  D_insertAtTail(tail,20);
    //  D_insertAtTail(tail,30);
    //  D_insertAtTail(tail,40);
    //  print(head);

    // insertion at a position
    //  D_insertAtPosition(head, tail, 4, 10);
    //  print(head);

    // deletion at a position
    //  D_deleteAtPosition(head,tail,5);
    //  print(head);

    //(done)HW->deletion at a value in DLL
    ...
    // insertion at position wrt tail
    // Cnode *tail = NULL;
    // C_insertAtPosition(tail, 1, 10);
    // C_insertAtPosition(tail, 2, 11);
    // C_insertAtPosition(tail, 3, 12);
    // C_insertAtPosition(tail, 4, 13);
    // C_insertAtPosition(tail, 5, 14);
    // C_insertAtPosition(tail, 6, 15);
    // C_insertAtPosition(tail, 7, 16);
    // C_insertAtPosition(tail, 8, 18);
    // C_insertAtPosition(tail, 1, 9);
    // print(tail);
    // cout << tail->data << endl;

    // insertion at value
    // C_insertAtValue(tail, 16, 17); // note our tail wont change and it doesn't matter in this type of insertion
    // print(tail);

    // deleteion at a value
    // C_deleteAtValue(tail, 20);
    // print(tail);

    //(done)HW->write all the codes for circular doubly linked list

    // Cdnode *head = new Cdnode(10);
    // for(int i=1;i<10;i++){
    //     C_D_insertAtPosition(head,2,i);
    // }
    // print(head);
    // C_D_insertAtValue(head,1,100);
    // C_D_deleteAtValue(head,1);
    // C_D_insertAtHead(head,11);
    // print(head);
